            ...
            children: [
              ...
              TextField(
                decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.search, color: Color.fromRGBO(201, 208, 219, 1),),
                    contentPadding: EdgeInsets.all(8.0),
                    hintText: 'Search Gym',
                  hintStyle: TextStyle(color: Color.fromRGBO(201, 208, 219, 1))
                ),
              ),
              SizedBox(height: 15,),
          Container(
            ...
            child: Scrollbar(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return gymCard("Colombo Gym", "Weekly progress on dieting", 23);
